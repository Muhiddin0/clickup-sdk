...
class ClickUp:
    ...
    def __init__(self, token: str):
        ...
        from .handlers import (
            TasksHandler, ListsHandler, SpacesHandler, 
            FoldersHandler, CommentsHandler, AttachmentsHandler,
            CustomFieldsHandler, GoalsHandler, TimeEntriesHandler,
            WebhooksHandler, UsersHandler, TeamsHandler
        )
    ...
    async def post(
        ...
        """Make POST request."""
        return await self._request("POST", endpoint, json_data=json_data, data=data, params=params, headers=headers)
